...
void __fastcall TForm1::Button22Click(TObject *Sender)
{
	...
	for (int i = 0; i < ADOQuery1->RecordCount; i++)
	{
		...
		if (reet.Pos(week) <= 0) // Проверка на наличие недели в переменной reet
		{
			...
			ListBox1->Items->Add("Неделя: " + week + " Год: " + ADOQuery1->FieldByName("year")->AsString); // Добавление недели и года в ListBox
		}
		ADOQuery1->Next();
	}
...
{
Edit13->Text = "Год";
  Edit14->Text = "Список недель:";
  Edit12->Text = "Номер недели";
  ComboBox4->Text = "Группа";
  ComboBox5->Text = "Курс";
  ComboBox6->Text = "Семестр";
  ComboBox1->Text = "Предмет";
  ComboBox2->Text = "Препод";
  ComboBox3->Text = "Кабинет";
  Edit6->Text = "День недели";
  Edit7->Text = "Неделя";
  Edit8->Text = "Пара";
  Edit9->Text = "Практичсекие занятия";
  Edit11->Text = "Сдача предмета";
  Edit15->Text = "Тип занятия";
  Memo1->Text = "Проверьте дату при добавлении, прошу)";
